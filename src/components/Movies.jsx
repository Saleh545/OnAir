...
const Movies = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        const response = await fetch(`https://www.omdbapi.com/?s=come&apikey=73a748a5`);
        ...
        <div className="slider-container relative overflow-hidden ">
          <Slider {...settings}>
            {movies.map((movie, index) => (
              ...
              >
                <img src={movie.Poster} alt={movie.Title} className="rounded-[4px] w-full h-full h-screencard-img" />
