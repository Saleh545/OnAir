...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (user) {
        navigate("/"); // Başarıyla giriş yapıldığında yönlendir
      } else {
          ...
          <div className="login-box rounded-[23px] flex flex-col items-center justify-center bg-[#00000099] pt-[26px] px-[95px] pb-[50px] mx-[25px]">
            ...
            <form onSubmit={handleSubmit} className="mt-[22px] mb-[37px] flex flex-col items-center justify-center">
              <input
                ...
                className="block w-[300px] bg-[#313131E6] outline-none py-[10px] pl-[21px] text-white"
              />
              <input
                type="password"
                ...
                className="block w-[300px] mt-[11px] bg-[#313131E6] outline-none py-[10px] pl-[21px] text-white"
              />
              <button
                type="submit"
                className="text-white px-[34px] cursor-pointer text-2xl font-medium py-[10px] rounded-full bg-[#E13C52] mt-[70px] hover:bg-[#f46174]"
              >
                Sign in
              </button>
            </form>
