        ...
        <div className="container max-w-screen-lg mx-auto flex items-center justify-center my-[40px] flex-col">
          ...
          <div className="login-box rounded-[23px] flex flex-col items-center justify-center bg-[#00000099] pt-[26px] px-[95px] pb-[50px] mx-[25px]">
            ...
            <form action=""className="mt-[22px] mb-[37px] flex flex-col items-center justify-center">
              ...
              <input type="tel" placeholder="Phone number" className="block w-[300px] mt-[11px] bg-[#313131E6] outline-none py-[10px] pl-[21px] text-white"/>
              <input type="email" placeholder="Email" className="block w-[300px] mt-[11px] bg-[#313131E6] outline-none py-[10px] pl-[21px] text-white" />
              <input type="password" placeholder="Password" className="block w-[300px] mt-[11px] bg-[#313131E6] outline-none py-[10px] pl-[21px] text-white" />
              <input type="password" placeholder="Confirm password" className="block w-[300px] mt-[11px] bg-[#313131E6] outline-none py-[10px] pl-[21px] text-white" />
